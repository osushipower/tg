...
class Estabelecimento(ndb.Model):
    ...
    info_estab = ndb.JsonProperty(default=[{'Ano': date.today().year, 'Months':{'Jan': 0, 'Feb': 0, 'Mar': 0, 'Apr': 0, 'May': 0,
    ...
    def check_year_existence(self, ano, mes):
        for dic in self.info_estab:
            ...
            if ano_dic and ano_dic == ano:
                ...
                self.info_estab.append({'Ano': date.today().year, 'Months':{'Jan': 0, 'Feb': 0, 'Mar': 0, 'Apr': 0, 'May': 0,
                    'Jun': 0, 'Jul': 0, 'Aug': 0, 'Sep': 0, 'Oct': 0, 'Nov': 0, 'Dec': 0}})
